...
import br.com.kesley.jobextra.services.UserService;
...
public class UserController {
   ...
   @GetMapping
   public ResponseEntity<List<User>> findAll(@RequestParam(value="name", required = false, defaultValue = "") String name, UriComponentsBuilder uriBuilder){
